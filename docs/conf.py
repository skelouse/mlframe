...
# -*- coding: utf-8 -*-
#
# mlframe documentation build configuration file, created by
...
version = mlframe.__version__
# The full version, including alpha/beta/rc tags.
release = mlframe.__version__
...
html_extra_path = ['docs/html/mlframe/mlframe.html']


# -- Options for HTMLHelp output ---------------------------------------

# Output file base name for HTML help builder.
htmlhelp_basename = 'mlframedoc'
